...
def create_pos_kds_router(db, require_roles):
    ...
    # ---- POS Recipes (legacy menu-item recipe stub — distinct from full F&B Recipe COGS) ----

    @router.get("/pos-recipes/{menu_item_id}")
    ...
    @router.get("/pos-recipes/property/{property_id}")
