    ...
    <div className="h-full flex flex-col" data-testid="housekeeping-panel">
      ...
      <div className="border-b border-stone-200 bg-white px-6 py-4 flex items-center justify-between flex-shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => window.dispatchEvent(new CustomEvent("open-report-issue"))} className="text-xs px-3 py-2 bg-orange-500 text-white rounded-xl font-bold hover:bg-orange-600 flex items-center gap-1" data-testid="new-maint-btn"><Wrench size={12} weight="fill" /> Maintenance</button>
        </div>
      </div>
