...
export const OwnerSummaryPanel = L(() => import("./components/dashboard/OwnerSummaryPanel"));
...
export const ForecastPlansPanel = L(() => import("./components/dashboard/ForecastPlansPanel"));
export const IntradayRepricePanel = L(() => import("./components/dashboard/IntradayRepricePanel"));
export const LastDayLadderPanel = L(() => import("./components/dashboard/LastDayLadderPanel"));
...
export const IdArchivePanel = L(() => import("./components/dashboard/IdArchivePanel"));
export const ModuleManagerPanel = L(() => import("./components/dashboard/ModuleManagerPanel"));
export const RebaseImpactPanel = L(() => import("./components/dashboard/RebaseImpactPanel"));
...
export const OwnerRatesAdminPanel = L(() => import("./components/dashboard/OwnerRatesAdminPanel"));
export const OwnerPulseAdminPanel = L(() => import("./components/dashboard/OwnerPulseAdminPanel"));
export const PortfolioBoardPanel = L(() => import("./components/dashboard/PortfolioBoardPanel"));
...
export const BasePriceCurvePanel = L(() => import("./components/dashboard/BasePriceCurvePanel"));
export const RevenueBrainPanel = L(() => import("./components/dashboard/RevenueBrainPanel"));
export const RmExpertisePanel = L(() => import("./components/dashboard/RmExpertisePanel"));
